...
pp_assassin_trigram_filter = SpamFilter.new(pp_assassin_training_dir, 'trigram')
pp_assassin_trigram_filter.print_table_info
pp_assassin_trigram_filter.classify_all("#{pp_assassin_testing_dir}spam/", 'spam')
pp_assassin_trigram_filter.classify_all("#{pp_assassin_testing_dir}ham/", 'ham')
