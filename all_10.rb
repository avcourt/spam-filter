...
puts "Running on all corpuses with feature selection minimum=4"

print "=========================================================================="
puts "==========================================================================="
pp_assassin_word_filter = SpamFilter.new(pp_assassin_training_dir, 'word-stem')
pp_assassin_word_filter.clean(min_feature_select)
...
pp_assassin_trigram_filter.clean(min_feature_select)
...
assassin_word_filter.clean(min_feature_select)
...
assassin_trigram_filter.clean(min_feature_select)
...
enron_word_filter.clean(min_feature_select)
...
enron_trigram_filter.clean(min_feature_select)
